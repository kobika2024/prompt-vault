...
export default function PromptBlock({ text, title = 'פרומפט' }: PromptBlockProps) {
  ...
  return (
    <div className="rounded-xl border border-sky-900/40 overflow-hidden">
      ...
      {/* תוכן */}
      <div className="bg-[#0b1220]" dir="ltr">
        {hasCodeBlock ? (
          <SyntaxHighlighter
            language="markdown"
            style={oneDark}
          ...
          <pre className="p-4 text-slate-300 text-sm leading-relaxed whitespace-pre-wrap font-mono text-right" dir="auto">
            {text}
          </pre>
        )}
      </div>
